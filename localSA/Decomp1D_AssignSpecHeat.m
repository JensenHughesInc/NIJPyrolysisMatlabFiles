function [specheat] = Decomp1D_AssignSpecHeat( specheat, ne, Teavg, node_div, aconst, bconst, cconst )
...
for i = 1:ne
    for j = 1:length(node_div)
        if(i<node_div(j))
            ...
            specheat(i)  = SpecificHeatFunction(aconst, bconst, cconst, 120, 29, 8, Teavg(i));
            break
        end
    end
end