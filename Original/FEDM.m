...
if(strcmp(SA_flag, 'dh'))
    dh = SA*Decomp1D_AssignEnthalpies( dh, ne, Teavg, Tr, node_div, acv, bcv, ccv, ...
    dhrec, trans, Feavg );
else
...
if(strcmp(SA_flag, 'dhg'))
    dhg = SA*Decomp1D_AssignEnthalpies( dhg, ne, Teavg, Tr, node_div, acg, bcg, ccg, ...
